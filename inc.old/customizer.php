...
function wpastartersite_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'typography',
        array(
            'title' => __( 'Preset Styles', 'wpastartersite' ),
            //'description' => __( 'This is a section for the typography', 'wpastartersite' ),
            'priority' => 20,
        )
    );
    //Theme Option
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'theme_option_setting', array(
        'label' => __( 'Theme Option', 'wpastartersite' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_style_setting', array(
        'label' => __( 'Typography', 'wpastartersite' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_color_scheme_setting', array(
        'label' => __( 'Color Scheme', 'wpastartersite' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_section(
        'header_image',
        array(
            'title' => __( 'Header Banner', 'wpastartersite' ),
            'priority' => 30,
        )
    );
    ...
    $wp_customize->add_control(
        'header_img',
        array(
            'label' => __( 'Header Image', 'wpastartersite' ),
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_bg_color',
            array(
                'label'      => __( 'Header Banner Background Color', 'wpastartersite' ),
    ...
    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => __( 'To customize the contents of this header banner and other elements of your site go to Dashboard - Appearance - Customize','wpastartersite' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
        'label' => __( 'Banner Tagline', 'wpastartersite' ),
        'section'    => 'header_image',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_visibility', array(
        ...
        'label'    => __('Remove Header Banner', 'wpastartersite'),
        'section'    => 'header_image',
        'type'     => 'checkbox',
    ) ) );
   ...
   $wp_customize->add_section(
        ...
        array(
            'title' => __( 'Other Customizations', 'wpastartersite' ),
            //'description' => __( 'This is a section for the header banner Image.', 'wpastartersite' ),
            'priority' => 40,
        )
    );
    $wp_customize->add_section(
        'colors',
        array(
            'title' => __( 'Background Color', 'wpastartersite' ),
            //'description' => __( 'This is a section for the header banner Image.', 'wpastartersite' ),
            'priority' => 50,
    ...
    $wp_customize->add_section(
        'background_image',
        array(
            'title' => __( 'Background Image', 'wpastartersite' ),
            //'description' => __( 'This is a section for the header banner Image.', 'wpastartersite' ),
            'priority' => 60,
            'panel' => 'styling_option_panel',
        )
    ...
    $wp_customize->add_setting( 'wpastartersite_logo', array(
        //'default' => __( '', 'wpastartersite' ),
        'sanitize_callback' => 'esc_url',
    ) );
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'wpastartersite_logo', array(
        'label'    => __( 'Upload Logo (replaces text)', 'wpastartersite' ),
        'section'  => 'title_tagline',
        'settings' => 'wpastartersite_logo',
    ) ) );

}
add_action( 'customize_register', 'wpastartersite_customize_register' );

add_action( 'wp_head', 'wpastartersite_customizer_css');
function wpastartersite_customizer_css()
{
    ?>
    <style type="text/css">
 ...
 */
function wpastartersite_customize_preview_js() {
    wp_enqueue_script( 'wpastartersite_customizer', get_template_directory_uri() . '/inc/assets/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'wpastartersite_customize_preview_js' );
